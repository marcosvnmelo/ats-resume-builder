...
export default function FaFacebook(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      {/* Icon from Font Awesome 6 Brands by Dave Gandy - https://creativecommons.org/licenses/by/4.0/ */}
      <path
        fill="currentColor"
